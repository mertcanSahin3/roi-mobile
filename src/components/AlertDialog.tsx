/*
Author: Umutcan SAHIN
Date: 2023-04-20T18:20:17.734Z
*/

import React, { Component } from 'react';
import { View, TouchableOpacity, StyleSheet, Dimensions, TouchableWithoutFeedback, ScrollView, TouchableHighlight } from 'react-native';
...
class AlertDialog extends Component<Props, State> {
  ...
  */
    ...
    render() {
        const { isVisible, content, title, height, mode, onClose, titleLeftComp, scrollEnabled } = this.state;
